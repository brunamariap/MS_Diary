...
async def get_student_grades(student_id: str, diary_id: Optional[str] = None) -> List[GradeResponse]:
    response = await gradeService.get_student_grades(student_id, diary_id)
    if not response:
