...
SCHEMA_PATH = Path('C:/Users/bruna/Documentos/NAPNE_acompanha_microservices/MS_Diary/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\bruna\\.cache\\prisma-python\\binaries\\5.4.2\\ac9d7041ed77bcc8a8dbd2ab6616b39013829574\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma:
    grade: 'actions.GradeActions[models.Grade]'
    diary: 'actions.DiaryActions[models.Diary]'
    ...
    def __init__(
        ...
        *,
        ...
        self.grade = actions.GradeActions[models.Grade](self, models.Grade)
        self.diary = actions.DiaryActions[models.Diary](self, models.Diary)
...
class Batch:
    grade: 'GradeBatchActions'
    diary: 'DiaryBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.grade = GradeBatchActions(self)
        self.diary = DiaryBatchActions(self)
